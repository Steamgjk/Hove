...
parser.add_argument('--sta', default="0", type=int, help='sta lidx')
parser.add_argument('--ed', default="13", type=int, help='ed lidx')
...
if __name__ == '__main__':
	...
	subnet = myVGG("VGG19", sta_lidx = sta_lidx, end_lidx = ed_lidx)
	subnet.to("cuda")
